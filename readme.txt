...
* `[papertrail_ai]` shortcode and a matching Gutenberg block
...
5. Embed the library anywhere with the `[papertrail_ai]` shortcode or the PaperTrail AI block.
...
* `[papertrail_ai]` shortcode and matching Gutenberg block.
